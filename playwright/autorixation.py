...
# with sync_playwright() as playwright:
    ...
    # pasword_input = page.locator('//div[@data-testid="login-form-password-input"]//div//input')
    # pasword_input.fill('Password')
    ...
    # # expect(wrong_email_or_password_allert).to_be_hidden()
