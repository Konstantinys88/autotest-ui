...
class LoginPage(BasePage):
    def __init__(self, page, Page):
        ...
        self.email_input = page.get_by_test_id('login-form-password-input').locator('input')
        self.password_input = page.get_by_test_id('login-form-password-input').locator('input')
        self.login_button = page.get_by_test_id('login-page-login-button')
        self.registration_link = page.get_by_test_id('data-testid="login-page-registration-link"')
    ...
    def check_wisible_wrong_email_or_password_alert(self):
